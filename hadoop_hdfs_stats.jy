...
""" Jython program to count the number of blocks per file in Hadoop HDFS or for all files under given directories"""

# BASIC USAGE:  jython -J-cp `hadoop classpath` hadoop_hdfs_count_blocks.jy [options] <list of HDFS files and/or directories>
...
# ============================================================================ #
#
# 3. Run this program against the file or directory tree to get a count of the number of blocks and blocksize
#
#    >>>  jython -J-cp `hadoop classpath` hadoop_hdfs_count_blocks.jy /tmp/testfile
#
# ============================================================================ #
...
try:
    ...
    die("Couldn't find Hadoop Java classes, try:  jython -J-cp `hadoop classpath` hadoop_hdfs_count_blocks.jy <args>")
...
def usage(*msg):
    ...
    die("""
================================================================================
%s  by Hari Sekhon  -  version %s
================================================================================

Prints the number of blocks per file and the blocksize for each file argument and
all files under any given directory argument
